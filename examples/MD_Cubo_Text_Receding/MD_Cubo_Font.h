//
// MD_Cubo Font data table and related functions
//

#pragma once

// Standard font - variable spacing
const uint8_t PROGMEM _fontData[] =
{
  0,							// 0 - 'Empty Cell'
...
uint16_t getFontCharOffset(uint8_t c)
{
	uint16_t	offset = 0;
...
uint8_t getFontChar(uint8_t c, uint8_t size, uint8_t *buf)
{
  if (buf == NULL) 
    return(0);
